...
public class AppFuseExporter extends GenericExporter {
    ...
    public void doStart() {
        ...
        configureExporter("appfuse/service/service-bean.ftl", "src/main/resources/{class-name}Manager-bean.xml").start();
        ...
        if (webProject) {
            ...
            // this class doesn't handle integration - just code generation
        }
    }
