...
<!--${pojo.shortName}Action-START-->
        <action name="${pojoNameLower}s" class="${pojoNameLower}Action" method="list">
            <result>/WEB-INF/pages/${pojoNameLower}List.jsp</result>
        </action>

        <action name="edit${pojo.shortName}" class="${pojoNameLower}Action" method="edit">
            <result>/WEB-INF/pages/${pojoNameLower}Form.jsp</result>
            <result name="error">/WEB-INF/pages/${pojoNameLower}List.jsp</result>
        </action>

        <action name="save${pojo.shortName}" class="${pojoNameLower}Action" method="save">
