...
public class Role extends BaseObject implements Serializable, GrantedAuthority {
     ...
     *                                    column="username"
     *                                    
     * We need to ignore users for webservice, because we use document/literal encoding style which
     * doesn't know about references, so a cyclic relation will leas to a stack overflow.
