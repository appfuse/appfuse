...
public abstract class ConfigMojoBase extends MojoBase {
    ...
    public void execute() throws MojoExecutionException {
        ...
        // instance tasks
        LoadFile loadFileTask = this.createLoadFileTask(this.getConfigInFile(), this.getConfigPropertyName());
    ...
    /**
     * This method will create an ANT based Replace task based on a file, token, and value attribute.
     *
