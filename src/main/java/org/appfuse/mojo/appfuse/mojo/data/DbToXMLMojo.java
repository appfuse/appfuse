...
/**
 * This mojo class will reverse engineer a set of hbm.xml files from a database
 * connection.
 * 
...
public class DbToXMLMojo extends MojoBase {
	...
	public String toString() {
		...
		buffer.append("databasePropertiesFile = ").append(
				databasePropertiesFile);
		buffer.append(", reverseEngineeringConfigurationFile = ").append(
